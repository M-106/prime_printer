...
setup(
  ...
  classifiers=[
    ...
    'Operating System :: Windows',  # Specifically for Windows
    # 'Operating System :: MacOS',    # Specifically for macOS
    'Operating System :: POSIX',   # Specifically for Unix-like systems (Linux)
  ],
)
